...
const Course3 = () => {
  ...
  useEffect(() => {
    for (const key in course) {
      if (Object.hasOwnProperty.call(course, key)) {
        ...
        if (element.courseId === "course-3") setLinkClass("");
      }
    }
  ...
  const clickHandler = () => {
    if (localStorage.getItem("user"))
      window.location =
        "https://docs.google.com/forms/d/e/1FAIpQLSeN7X9d8e0VQBoig5G8TLNu5N0Jpx9IlzsbkG8iltyctx4dIA/viewform";
      ...
      <Container fluid className="mt-4">
        <Row>
          ...
          <Col>
            ...
            <h1 className="mt-3 p-2">25 Comprehensive Case Law Summaries</h1>
            <p className="justify p-2">
              This package will provide summaries of 25 Most Important, Latest
              and Landmark Case Laws that focuses on points important for CLAT
              PG exam like Related Cases, Key Findings, Relevant Statutes and
              Amendments. This package also contains a LIST of the LATEST
